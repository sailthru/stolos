...
@with_setup
def test_bypass_scheduler(zk, bash1, job_id1, log, tasks_json_tmpfile):
...
@with_setup
def test_no_tasks(zk, app1, app2, log, tasks_json_tmpfile):
    """
...
@with_setup
def test_push_tasks(zk, app1, app2, job_id1, log, tasks_json_tmpfile):
    """
...
@with_setup
def test_rerun_pull_tasks(zk, app1, app2, job_id1, log, tasks_json_tmpfile):
...
@with_setup
def test_complex_dependencies_readd(zk, depends_on1, log, tasks_json_tmpfile):
    job_id = '20140601_1'
...
@with_setup
def test_pull_tasks(zk, app1, app2, job_id1, log, tasks_json_tmpfile):
    """
...
@with_setup
def test_bash(zk, bash1, job_id1, log, tasks_json_tmpfile):
...
@with_setup
def test_invalid_queued_job_id(zk, app4, log, tasks_json_tmpfile):
