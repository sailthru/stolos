...
def func(app_name, **parsed_job_id):
    ...
    for a particular job_id or you wish to have the scheduler mark specific
    job_ids as "skipped"
    ...
    **parsed_job_id - specifies the identifiers that make up the job_id.
    ...
    In this particular example, this function will not let the scheduler queue
    ...
    will not be queued by the scheduler, and will instead be marked as
    "skipped"
