"""
Fetch scheduler configuration from redis rather than from a json file.
"""
import os
import redis
...
class RedisMapping(_RedisConfig, TasksConfigBaseMapping):
    ...
    def __init__(self, data=None,
                 db=int(os.environ.get('SCHEDULER_REDIS_DB', 0)),
                 host=os.environ.get('SCHEDULER_REDIS_HOST', 'localhost'),
                 port=int(os.environ.get('SCHEDULER_REDIS_PORT', 6379)),
